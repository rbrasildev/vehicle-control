<div class="card rounded-xl shadow bg-base-200 mt-2 p-4">
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td class=" px-4 flex items-center">
                            <div class="w-full bg-gray-200 rounded-full h-2 dark:bg-gray-700 flex items-center gap-2">
